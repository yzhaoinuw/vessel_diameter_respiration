%% Compute Pearson HR-vessel correlations and across-mouse Wilcoxon tests
...
excluded_csv = fullfile(output_folder, 'hr_amp_corr_pearson_excluded_subjects.csv');
