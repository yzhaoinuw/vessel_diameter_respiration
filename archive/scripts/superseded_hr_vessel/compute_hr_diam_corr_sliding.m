%% Compute HR-vessel correlations from sliding-bin hr_amp_data_sliding.mat files
...
fprintf("\nSliding-bin correlation results:\n");
disp(results_table);

writetable(results_table, fullfile(results_folder, "hr_amp_corr_summary_sliding.csv"));
writetable(excluded_table, fullfile(results_folder, "hr_amp_corr_excluded_subjects_sliding.csv"));
