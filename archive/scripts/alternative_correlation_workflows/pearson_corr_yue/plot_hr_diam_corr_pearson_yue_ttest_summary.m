%% Plot Fisher z t-test summaries for Yue Pearson correlations
...
if ~exist(by_mouse_csv, 'file') || ~exist(ttest_csv, 'file')
    error('Missing Yue Pearson t-test inputs. Run compute_hr_diam_corr_pearson_yue_ttest.m first.');
end
...
sgtitle('Across-mouse Pearson Yue correlations with Fisher z t-test summary', 'Interpreter', 'none', 'FontSize', 12);
out_file = fullfile(fig_folder, 'pearson_yue_ttest_summary.png');
