%% Compute Spearman HR-vessel correlations using results.avg_HR_Yue_10min
...
excel_file = fullfile(output_folder, 'hr_amp_corr_yue_spearman_results.xlsx');
...
excluded_csv = fullfile(output_folder, 'hr_amp_corr_yue_spearman_excluded_subjects.csv');
