%% Plot Fisher z t-test summaries for mouse-level Spearman correlations
...
ttest_csv = fullfile(output_folder, 'hr_amp_corr_spearman_ttest_summary.csv');

if ~exist(by_mouse_csv, 'file') || ~exist(ttest_csv, 'file')
    error('Missing Spearman t-test inputs. Run compute_hr_diam_corr_spearman_ttest.m first.');
end
...
sgtitle('Across-mouse Spearman correlations with Fisher z t-test summary', ...
    'Interpreter', 'none', 'FontSize', 12);

out_file = fullfile(fig_folder, 'spearman_ttest_summary.png');
