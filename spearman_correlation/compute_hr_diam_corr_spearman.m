%% Compute Spearman HR-vessel correlations and across-mouse Wilcoxon tests
...
excluded_csv = fullfile(output_folder, 'hr_amp_corr_spearman_excluded_subjects.csv');
